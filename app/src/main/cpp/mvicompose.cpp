...
Java_com_example_mvicompose_cryptography_CryptographyManagerImpl_getKeySize(
        JNIEnv *env,
        jobject thiz
) {
    return 128;
...
Java_com_example_mvicompose_ui_feature_main_MainViewModel_generateHelloString(
        JNIEnv *env,
        jobject thiz,
        jstring name
) {
